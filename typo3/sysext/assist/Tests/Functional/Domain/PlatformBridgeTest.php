...
class PlatformBridgeTest extends FunctionalTestCase
{
    ...
    public function canResolveModels(): void
    {
        ...
        self::assertArrayHasKey('numb-encore', $models);
        self::assertSame(ChatModel::class, $models['numb-encore']['class']);
        self::assertContainsEquals(Capability::INPUT_MESSAGES, $models['numb-encore']['capabilities']);
        self::assertContainsEquals(Capability::INPUT_TEXT, $models['numb-encore']['capabilities']);
        self::assertContainsEquals(Capability::OUTPUT_TEXT, $models['numb-encore']['capabilities']);
        self::assertContainsEquals(Capability::TOOL_CALLING, $models['numb-encore']['capabilities']);
    }
}
