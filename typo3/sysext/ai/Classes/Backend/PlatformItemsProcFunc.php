...
namespace TYPO3\CMS\AI\Backend;

use Symfony\Component\DependencyInjection\Attribute\Autoconfigure;
use TYPO3\CMS\AI\Service\PackageService;
...
final readonly class PlatformItemsProcFunc
{
    ...
    public function getInstalledPlatformPackages(array &$parameters): void
    {
        $names = array_map(
            ...
            $this->packageService->getInstalledPackagesByType(PackageService::SYMFONY_AI_PLATFORM)
        );
